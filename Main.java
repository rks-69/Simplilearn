...
public class Main {
    ...
    private static void searchExpenses(final ArrayList<Integer> arrayList) {
        ...
        //The method is completed below
        Scanner sc=new Scanner(System.in);
        final int expSearch=sc.nextInt();
        if(arrayList.contains(expSearch))
        {
            System.out.println("Your search is found in the list\n");
        }
        else{
            System.out.println("Your searched element is not present in the records!\n");
        }
    }
    private static void sortExpenses(final ArrayList<Integer> arrayList) {
       ...
       //The arrayList is sorted in ascending order below.
